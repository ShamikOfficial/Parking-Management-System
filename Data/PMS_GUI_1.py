from Data.PMS_Loci_2 import *
from Data.PMS_Map_4 import *
from tkinter import *
...
def startDB():
    try:
        conn = sqlite3.connect('Data'+os.path.sep+'Location5.db')
        return conn
...
def loci():
    ...
    #print(temp[1][4])
        ...
        temp[a][b]='T'
        pd.DataFrame(temp).to_csv('Data'+os.path.sep+"map4.csv",header=None,index=False)
        for i in temp:
            print(i)
        print("*******EOL******")
